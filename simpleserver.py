...
# modules used to run a simple web server
import cgi
from wsgiref.simple_server import make_server
from wsgiref import util

# HTML template for the server interface
HTML_WRAP = '''\
<!DOCTYPE html>
<html>
  <head>
    <title>Site monitoring stats</title>
    <style>
...
def View(env, resp):
    '''
    View is the 'main page' and displays the information.
    '''
